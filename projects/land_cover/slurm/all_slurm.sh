...
for i in {1..10}; do sbatch slurm_predict_cas_trees.sh; done
for i in {1..10}; do sbatch slurm_predict_etz_trees.sh; done
for i in {1..10}; do sbatch slurm_predict_srv_trees.sh; done
