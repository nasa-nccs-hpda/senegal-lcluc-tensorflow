...
def plot_confusion_matrix(cm, label_name, class_names=['a', 'b', 'c']):
    ...
    plt.savefig('/home/geoint/tri/nasa_senegal/confusion_matrix/{}_cfn_matrix.png'.format(label_name[:-4]))
    plt.show()
...
if __name__ == '__main__':
    ...
    classes = ['Other', 'Tree/shrub', 'Croplands']  # 6-Cloud not present
    colors = ['brown', 'forestgreen', 'orange']
    ...
    predictions = sorted(glob.glob('/home/geoint/tri/nasa_senegal/predictions/61-0.10-512/images/*.tif'))
